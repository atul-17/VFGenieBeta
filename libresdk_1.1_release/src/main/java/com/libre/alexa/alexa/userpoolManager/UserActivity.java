...
public class UserActivity extends DeviceDiscoveryActivity {
    ...
    private void performAction(MenuItem item) {
        ...
        if (itemId == R.id.nav_user_add_attribute) {// Add a new attribute
            addAttribute();
        } else if (itemId == R.id.nav_user_change_password) {// Change password
            changePassword();
        } else if (itemId == R.id.nav_user_verify_attribute) {// Confirm new user
            // confirmUser();
            attributesVerification();
        } else if (itemId == R.id.nav_user_settings) {// Show user settings
            showSettings();
        } else if (itemId == R.id.nav_user_sign_out) {// Sign out from this account
            signOut();
        } else if (itemId == R.id.nav_user_trusted_devices) {
            showTrustedDevices();
        } else if (itemId == R.id.nav_user_about) {// For the inquisitive
